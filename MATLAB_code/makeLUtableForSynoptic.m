...
% that will feed into makeSynoptic or calculateSynoptic
% (which is in R right now...switching between languages..slightly unfortunate)
% Keep this with BATSallTime as it is no longer just a BIOS-SCOPE tool
% Krista Longnecker; 21 June 2024
% Krista Longnecker, 6 June 2026
% Krista Longnecker, 16 June 2026
clear all 
close all
...
workdir = fullfile(rootdir,'processedCTDdata\');
...
writetable(stepThree,fullfile(outdir,'BATSderivedValues_lookupTable.2026.06.16.csv'))
