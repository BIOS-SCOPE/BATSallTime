...
Added dummy end to the seasons as I have data files to the middle of June 2025, but only did the seasons in 2025 to May 2025. June 2025 will definitely be in stratified.
Calculate the new lookup table I need for other purposes.

- [x] Make sure the output from the new data sources matches the old data in terms of the calculations
